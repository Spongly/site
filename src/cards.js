  ...
  return (
    <div className={"introCard"+props.curState}>
      ...
      <div className="procode">
        ...
        <pre className="CodeMirror-line" role="presentation"><span role="presentation" style={{paddingRight: '0.1px'}}> &nbsp;<span className="cm-property">loves</span>: <span className="cm-string">"Linux"</span>,</span></pre>
        ...
        <pre className="CodeMirror-line" role="presentation"><span role="presentation" style={{paddingRight: '0.1px'}}> &nbsp;<span className="cm-property">uses</span>: <span className="cm-string">"arch"</span></span></pre>
        <pre className="CodeMirror-line" role="presentation"><span role="presentation" style={{paddingRight: '0.1px'}}>{"}"}</span></pre>
      </div>
    </div>
  )
  ...
  return (
    <div className={"introCard"+props.curState}>
      ...
      <div className="procode">
        ...
        <pre className="CodeMirror-line" role="presentation"><span role="presentation" style={{paddingRight: '0.1px'}}> &nbsp;<span className="cm-property"></span>: <span className="cm-string">"COMING SOON"</span></span></pre>
